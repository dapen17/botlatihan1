...
async def configure_event_handlers(client, user_id):
    ...
    @client.on(events.NewMessage(pattern=r'^305 hastle (.+) (\d+[smhd])$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 stop$'))
    ...
    # Tes koneksi bot
    @client.on(events.NewMessage(pattern=r'^305 ping$'))
    async def ping_handler(event):
        await event.reply("🏓 Pong! Bot aktif.")
        message_count[get_today_date()] += 1

    # Broadcast pesan ke semua chat kecuali blacklist
    @client.on(events.NewMessage(pattern=r'^305 bcstar (.+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 bcstarw (\d+[smhd]) (.+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 stopbcstarw$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 bcstargr(\d+) (\d+[smhd]) (.+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 stopbcstargr(\d+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 bl$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 unbl$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 help$'))
    async def help_handler(event):
        help_text = (
            "📋 **Daftar Perintah yang Tersedia:**\n\n"
            "1. 305 hastle [pesan] [waktu][s/m/h/d]\n"
    ...
    # Atur auto-reply
    @client.on(events.NewMessage(pattern=r'^305 setreply (.+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^305 stopall$'))
